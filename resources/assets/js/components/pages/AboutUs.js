												            ...
												            <div className="about-description text-center">
												                <div className="row flex-center">
												    				<div className="col-md-8">
												    					<h5 className="description">توسعه سامان فعالیت خود را بصورت تخصصی از سال 1381 در زمینه تجارت الکترونیک و فناوری اطلاعات آغاز کرد. فعالیت های شرکت در سه مسیر کلی تولید سیستم‌های تحت وب، ارائه سرویس‌های بنیادی تحت وب و سرویس‌های تخصصی اینترنت و تولید بازی های رایانه‌ای می‌باشد.
